...
<header class="navbar-wrapper">
    <div class="navbar navbar-black navbar-fixed-top">
        <div class="container cl">
            <a class="logo navbar-logo hidden-xs" href="/aboutHui.shtml">阿卡林-星哥的博客</a>
            <a class="logo navbar-logo-m visible-xs" href="/aboutHui.shtml">H-ui</a>
            <span class="logo navbar-slogan hidden-xs">专注 &middot; 分享 &middot; PHP技术</span>
            <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
            <nav class="nav navbar-nav nav-collapse" role="navigation" id="Hui-navbar">
                <ul class="cl">
                    <li class="current"><a href="/">首页</a></li>
                    <li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">PHP技术<i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="#">类库推荐</a></li>
                            <li><a href="#">技巧拾遗</a></li>
                        </ul>
                    </li>
                    <li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">前端技术<i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                    ...
                    <li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">后端技术<i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="#">PHP</a></li>
                    ...
                    <li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">数据技术<i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="#">MySql</a></li>
                            <li><a href="#">Redis</i></a></li>
...
<div id="container" style="width: 80%; height: 300px;">

</div>
<footer class="footer mt-20">
    <div class="container">
        <nav class="footer-nav">
            <a target="_blank" href="/aboutHui.shtml">阿卡林-星哥的博客</a>
